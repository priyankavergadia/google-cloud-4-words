...
* **Cloud Firestore (formerly Datastore)**: Strongly-consistent NoSQL document DB [<sup>:link:</sup>](https://cloud.google.com/firestore/) [<sup>:page_facing_up:</sup>](https://cloud.google.com/firestore/docs/)
